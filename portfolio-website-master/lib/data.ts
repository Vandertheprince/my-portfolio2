...
export const experiencesData = [
  ...
  },
  {
    ...
    location: "Iloilo City, Iloilo",
    description:
      "I interned in a government bureau wherein I offered my services as an Information Technology student.",
...
export const projectsData = [
  {
    title: "RDS-EMB",
    description:
      "I offered my services as a support system developer on this project during my internship. This system is used by the records section of the EMB-DENR.",
